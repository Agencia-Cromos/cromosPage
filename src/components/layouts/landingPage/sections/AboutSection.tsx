            ...
            >
              <span className="flex items-start justify-start transition duration-300 group-hover:scale-[1.05]">
                ...
                >
                  ...
                  <item.icon aria-hidden="true" fill={`url(#gradient-${index})`} />
                </svg>
              </span>
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg font-headline text-gray-900 dark:text-white">
                  {item.headline}
                </p>
